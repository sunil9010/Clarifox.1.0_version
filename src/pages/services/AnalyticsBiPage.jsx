...
import { ArrowRight, BarChart, Database, TrendingUp, CheckCircle } from 'lucide-react';
  ...
  return (
    <PageWrapper>
      <Helmet>
        ...
        <meta name="description" content="Transforming Data into Actionable Insights with Clarifox's Analytics & BI services. We offer data warehousing, interactive dashboards, and predictive analytics." />
      </Helmet>
    ...
    >
      ...
      <div className="py-24 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-screen-xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-foreground mb-4">Unlock Data-Driven Decisions</h2>
            <p className="text-lg text-muted-foreground">In the age of big data, the ability to extract meaningful insights is a key competitive advantage. Our Analytics & BI services help you make sense of your data. We design and build robust data pipelines, create intuitive dashboards, and implement advanced analytics solutions to empower data-driven decision-making across your organization.</p>
          </motion.div>
          ...
          <div className="space-y-20">
            {features.map((feature, index) => (
              ...
              >
                <div className={`relative h-96 rounded-2xl shadow-2xl overflow-hidden group ${index % 2 !== 0 ? 'lg:col-start-2' : ''}`}>
                  <img  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt={feature.alt} src={feature.image} />
                </div>
          ...
          <section className="py-24">
            <h2 className="text-3xl font-bold text-center text-foreground mb-12">Example: Power BI Dashboard</h2>
            <motion.div
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-muted p-6 rounded-lg">
                  ...
                  <img  className="w-full h-auto rounded-md shadow-md" alt="A sample bar chart showing sales data" src="images/sales_performance.png" />
                </div>
                <div className="space-y-6">
                  ...
                  <div className="bg-muted p-6 rounded-lg">
                    <img  className="w-full h-auto rounded-md shadow-md" alt="A sample pie chart showing market share" src="https://images.unsplash.com/photo-1595512618325-86df927c7b4c" />
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            <div className="bg-secondary rounded-2xl p-12 max-w-4xl mx-auto shadow-lg">
              <h2 className="text-3xl font-bold text-foreground mb-6">Ready to Become a Data-Driven Organization?</h2>
              <p className="text-xl text-muted-foreground mb-8">Unlock the hidden value in your data with our expert analytics services.</p>
