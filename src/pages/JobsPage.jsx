...
const JobsPage = () => {
  ...
  "🚀 Explore exciting tech roles from top companies!",
  "💼 New jobs added every week — don’t miss out!",
...
>
  ...
  <motion.p
    ...
    className="mt-6 text-lg text-amber-100 font-medium"
  >
